...
import { http, HttpResponse } from 'msw'; // 替换 rest �?http + HttpResponse
...
export const handlers = [
  ...
  http.get('/api/banner', () => {
    ...
    return HttpResponse.json({
      ...
      data: [
        {
          id: 1,
          title: "2025-2026年度工作室招新启�?,
          subtitle: "加入我们，共创精�?,
          description: "覆盖技术、设计、运营等多个方向，提供系统化培训与实践机�?,
          buttonLink: "/recruit/2025",
          imageUrl: "/static/banners/banner1.webp",
          order: 1,
          active: true
        },
        {
          ...
          title: "当前部分页面仍处于开发阶�?,
          subtitle: "开发阶段，敬请期待",
          description: "我们将尽快开发完成，也期待更多的同学加入我们",
          buttonLink: "/project/award/2025",
          imageUrl: "/static/banners/banner2.webp",
          order: 2,
          active: true
        },
        {
          ...
          title: "欢迎来到BDIS工作�?,
          subtitle: "welcome",
          description: "大数据智能工作室欢迎�?,
          buttonLink: "/cooperation/tech2025",
          imageUrl: "/static/banners/banner3.webp",
          order: 3,
          active: true
        }
      ]
      ...
      data: [
        {
          ...
          link: "/news/1",
          coverThumbUrl: "/static/news/news1.webp",
          order: 1
        },
        {
          id: 2,
          title: "2月组会：大模型应用与官网开发实践分�?,
          category: "activity",
          summary: "分享近期大模型应用与官网开发的实践体会�?,
          publishDate: "2026-02-15",
          link: "/news/2",
          coverThumbUrl: "/static/news/news2.webp",
          order: 2
        },
        {
          id: 3,
          ...
          link: "/news/3",
          coverThumbUrl: "/static/news/news3.webp",
          order: 3
        },
        {
          id: 4,
          title: "创新竞赛与组队板块试行版上线公告",
          category: "contest",
          summary: "集中展示赛事信息，支持发布和查询组队�?,
          publishDate: "2026-03-01",
          link: "/news/4",
          coverThumbUrl: "/static/news/news4.webp",
          order: 4
        },
        {
          id: 5,
          ...
          link: "/news/5",
          coverThumbUrl: "/static/news/news5.webp",
          order: 5
        }
      ].slice(0, limit)
    });
    ...
    const all = [
      {
        ...
        progress: 82,
        recruitRoles: ["运维"],
        members: ["丁祎", "郭敦�?, "杨思琦", "朱玉�?, "李林�?],
        updatedAt: "2025-11-15",
        coverUrl: "/static/news/news1.webp",
        link: "/projects/p-001",
        order: 1
      },
      {
        ...
        progress: 10,
        recruitRoles: ["�?],
        members: ["丁祎", "杨思琦", "朱玉�?, "李林�?],
        updatedAt: "2026-11-01",
        coverUrl: "/static/news/news2.webp",
        link: "/projects/p-002",
        order: 2
      },
      {
        id: "p-003",
        name: "企业合作：数据标注与质检",
        tagline: "建立小批量数据标注与抽检质控流程，沉淀统一规范与交付节奏，为后续规模化合作提供可复制范�?,
        status: "recruiting",
        progress: 15,
        recruitRoles: ["数据标注", "质检", "项目助理"],
        members: ["招募�?],
        updatedAt: "2025-10-28",
        coverUrl: "/static/news/news3.webp",
        link: "/news/5",
        order: 3
      },
    ]
  ...
  http.get('/api/platform/forum', ({ request }) => {
    ...
    const all = [
      ...
      {
        id: "f-002",
        title: "互联�? 项目组队｜缺前端（Vue�? 后端（SpringBoot�?,
      ...
      },
      {
        ...
        deadline: "2026-02-20",
        link: "/forum/f-004",
        coverUrl: "/static/news/news4.webp",
        order: 4
      },
      {
        id: "f-005",
        ...
        deadline: "2026-01-18",
        link: "/forum/f-005",
        coverUrl: "/static/news/news5.webp",
        order: 5
      }
    ]
    // --- 过滤 ---
  ...
  http.get('/api/resources', ({ request }) => {
    ...
    const allResources = [
      ...
      },
      {
        id: 2,
        title: 'React 18 新特性详�?,
        description: '深入解析 React 18 的新特性，包括并发渲染、Suspense 等核心概�?,
        category: 'frontend',
      ...
      },
      {
        ...
        description: '从零开始学�?Spring Boot，包含项目搭建、配置、数据库集成等实战内�?,
        category: 'backend',
        link: 'https://www.bilibili.com/video/BV1Lq4y1J77x/?spm_id_from=333.337.search-card.all.click'
      },
      {
        id: 4,
        title: 'MySQL 数据库从入门到精�?,
        description: 'SQL基础、事务、索引、SQL优化、锁、InnoDB存储引擎、日志、主从复制、分库分表、读写分�?,
        category: 'database',
      ...
      },
      {
        ...
        description: 'TypeScript 高级类型、泛型、装饰器等进阶知�?,
        category: 'frontend',
      ...
      },
      {
        id: 8,
        title: 'Node.js 后端开发实�?,
        description: '使用 Node.js 开�?RESTful API，包�?Express、中间件、认证等内容',
        category: 'backend',
      ...
      },
      {
        id: 9,
        title: 'MongoDB 快速入�?,
        description: 'NoSQL 数据�?MongoDB 的基础操作、数据建模和查询优化',
        category: 'database',
      ...
      },
      {
        ...
        description: 'Webpack 5 模块打包、代码分割、优化配置等前端工程化内�?,
        category: 'frontend',
      ...
      },
      {
        ...
        description: '使用 PyTorch 进行神经网络编程，从基础到高级应�?,
        category: 'ai',
  ...
  http.get('/api/announcements', ({ request }) => {
    ...
    const allAnnouncements = [
      ...
      },
      {
        ...
        link: "/info/news",
        coverThumbUrl: "/static/news/news8.webp",
        order: 3
      },
      {
        id: 4,
      ...
      },
      {
        ...
        category: "activity",
        summary: "邀请资深开发者分�?Vue 3 在实际项目中的应用经验和最佳实践�?,
        publishDate: "2026-03-10",
        link: "/info/news",
        coverThumbUrl: "/static/news/news6.webp",
        order: 6
      },
      {
        id: 7,
        title: "科研项目中期交流讨论�?,
        category: "activity",
        summary: "关于进一步建设与测试心理健康预警模型的讨论与交流",
        publishDate: "2026-04-12",
        link: "/info/news",
        coverThumbUrl: "/static/news/news7.webp",
        order: 7
      },
      {
        id: 8,
      ...
      },
      {
        ...
        link: "/info/news",
        coverThumbUrl: "/static/news/news9.webp",
        order: 9
      },
    ]
